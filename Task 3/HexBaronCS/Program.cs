...
grid.AddPiece(false, "Serf", 23);
        ...
        public static void PlayGame(Player player1, Player player2, HexGrid grid)
        {
            ...
            do
            {
                ...
                if (gameOver)
                {
                    grid.DestroyPiecesAndCountVPs(ref player1, ref player2, ref player1VPsGained, ref player2VPsGained);
                }
                else
                    gameOver = grid.DestroyPiecesAndCountVPs(ref player1, ref player2, ref player1VPsGained, ref player2VPsGained);
    ...
    class HexGrid
    {
        ...
        public bool DestroyPiecesAndCountVPs(ref Player player1, ref Player player2, ref int player1VPs, ref int player2VPs)
        {
