...
namespace HexBaronCS
{
    class Program
    {
        ...
        public static void SetUpDefaultGame(out Player player1, out Player player2, out HexGrid grid)
        {
            ...
            int gridSize = 8;
            grid = new HexGrid(gridSize);
            Console.Write("Player 1 enter your username: ");
            string name1 = Console.ReadLine();
            Console.Write("Player 2 enter your username: ");
            string name2 = Console.ReadLine();

            player1 = new Player(name1, 0, 10, 10, 5);
            player2 = new Player(name2, 1, 10, 10, 5);
            grid.SetUpGridTerrain(t);
